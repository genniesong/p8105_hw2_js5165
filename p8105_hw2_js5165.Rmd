...
```{r p2.2}
p2_2016 = read_excel(path = './data/HealthyHarborWaterWheelTotals2017-9-26.xlsx',sheet = '2016 Precipitation',range = cell_rows(2:14))%>%
  janitor::clean_names()%>%
  mutate(year=2016)

p2_2017 = read_excel(path = './data/HealthyHarborWaterWheelTotals2017-9-26.xlsx',sheet = '2017 Precipitation',range = cell_rows(2:10))%>%
  janitor::clean_names()%>%
  mutate(year=2017)
